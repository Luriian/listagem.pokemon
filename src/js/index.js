/* O que precisamos fazer? - quando clicarmos no botão de troca de tema, temos que alterar a cor do tema da pagina
para as cores do tema claro ou do tema escuro.
...
botaoAlterarTema.addEventListener("click", () => {
    ...
    if (modoEscuroEstaAtivo) {
       ...
       imagemBotaoTrocaDeTema.setAttribute("src", "./css/imagens/sun.png");

    } else {
        body.classList.add("modo-escuro");
        imagemBotaoTrocaDeTema.setAttribute("src", "./css/imagens/moon.png");
